...
public class EndingFull extends AppCompatActivity {
    Intent intent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ending_full);

        Button next =  findViewById(R.id.button97);
...
//        super.onBackPressed();
        final Dialog dialog = new Dialog(EndingFull.this);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.finishAffinity(EndingFull.this);
                System.exit(0);
            }
        });
    }
