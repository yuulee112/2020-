...
public class EndingTopgrade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ending_topgrade);

        Button next = findViewById(R.id.button64);
...
//        super.onBackPressed();
        final Dialog dialog = new Dialog(EndingTopgrade.this);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.finishAffinity(EndingTopgrade.this);
                System.exit(0);
            }
        });
    }
