...
public class EndingFgrade extends AppCompatActivity {
    Intent intent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ending_fgrade);

        Button next =  findViewById(R.id.button59);
...
//        super.onBackPressed();
        final Dialog dialog = new Dialog(EndingFgrade.this);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.finishAffinity(EndingFgrade.this);
                System.exit(0);
            }
        });
    }
