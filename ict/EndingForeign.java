...
public class EndingForeign extends AppCompatActivity {
    Intent intent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ending_foreign);

        Button next =  findViewById(R.id.button68);
...
//        super.onBackPressed();
        final Dialog dialog = new Dialog(EndingForeign.this);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.finishAffinity(EndingForeign.this);
                System.exit(0);
            }
        });
    }
