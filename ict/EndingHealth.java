...
public class EndingHealth extends AppCompatActivity {
    Intent intent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ending_health);

        Button next =  findViewById(R.id.button100);
...
//        super.onBackPressed();
        final Dialog dialog = new Dialog(EndingHealth.this);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.finishAffinity(EndingHealth.this);
                System.exit(0);
            }
        });
    }
